...
Ask the user whether they want to continue now with the `create-adr` skill to generate the ADR from this PRD. **The user decides** — do not start it unprompted, and do not assume the answer is yes.
